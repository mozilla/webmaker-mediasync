...
module.exports = function( options, callback ) {
  ...
  function doSearch( id ) {
    // https://api.flickr.com/services/rest/?method=flickr.photos.licenses.getInfo&api_key=cc5ca51a9b6fc55c511c1dd5cc90b1ad&format=json&nojsoncallback=1
    var flickrLicenseIds = [
    ...
    var uri = "https://secure.flickr.com/services/rest/?method=flickr.photos.search&" + flickrKey +
              ...
              "&safe_search=1&license=" + (options.query.license || flickrLicenseIds.join(","));
